      ...
      <div className={styles.container}>
        <div className={styles.title}>
          ...
          <p data-aos="zoom-in">
            ...
            feedback. Our team is here to help with product inquiries, order
            details, compatibility questions, or anything else you might need.
            Don’t hesitate to reach out — we aim to respond quickly and ensure
            your experience with NextGear is smooth and satisfying. Your input
            helps us grow, improve, and better serve our community.
          </p>
        ...
        <div className={styles.location} data-aos="fade-up">
          ...
          ></iframe>
          <p>
            You can find us at our main office, where all the tech magic
            happens! Feel free to visit or reach out to us during business
            hours.
          </p>
        </div>
      </div>
